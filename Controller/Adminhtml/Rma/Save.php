...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Cap\CustomerRequest\Model\Rma::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->messageManager->addExceptionMessage(
                    $e,
                    __('Something went wrong while saving the Rma Request.')
                );
            }

            $this->dataPersistor->set('cap_customer_request_rma', $data);
